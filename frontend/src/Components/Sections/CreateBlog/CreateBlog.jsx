import bgw from '/assets/bgw.webp';

function CreateBlog (){
    
        return (        
            <section className={`h-screen -mt-15 flex items-center justify-center  bg-[url(https://thumbs.dreamstime.com/b/orange-black-waves-3058251.jpg)]  object-cover bg-cover `}>
